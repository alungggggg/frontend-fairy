...
import { addSoalPilgan, getSoalPilgan } from "../../../../lib/redux/api/soalPilgan";
...
const AddSoalPilgan = () => {
  ...
  function handleAddSoalPilgan(value) {
    dispatch(addSoalPilgan(value));
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <Formik
                ...
                validationSchema={AddSoalPilganSchema}
                onSubmit={(values) => {
                  handleAddSoalPilgan(values);
                }}
              >
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={() => {
                  document.getElementById("btnSubmitAddSoalPilgan").click();
                }}
              >
                Submit
              </button>
