...
const ForumQuizDetail = () => {
  ...
  var soalPilgans = forumQuiz[0]?.dongeng[0]?.soal_pilgan || [];
  var soalUraianSingkats = forumQuiz[0]?.dongeng[0]?.soal_uraian_singkat || [];
  var soalUraianPanjangs = forumQuiz[0]?.dongeng[0]?.soal_uraian_panjang || [];
